...
<script language="JavaScript" type="text/javascript" src="<%=basePath%>resource/js/FormValid.js"></script>
	...
	<body>
		<form action="<%=basePath%>servlet/OperatorAddServlet"  name="form1" onsubmit="return validator(this)"   method="post"
			...
			<table class=editTable cellSpacing=1 cellPadding=0 width="100%"
				...
				<tr>
					...
					<td width="41%" colspan="3" bgcolor="#FFFFFF">
						<input type="text" name="userAdmin"  maxlength="20" style="width: 145px" valid="required"  errmsg="账号不能为空!">
					</td>
					...
					<td colspan="3" bgcolor="#FFFFFF">
						<input type="password" name="userPass"  maxlength="20" style="width: 145px" valid="required"  errmsg="密码不能为空!">
						&nbsp;
					</td>
				...
				<tr>
					...
					<td colspan="3" bgcolor="#FFFFFF">
						<input type="text" style="width: 145px"  valid="isNumber"   errmsg="请输入正确的工号!"  maxlength="20"  name="userStaff" >
						&nbsp;
					</td>
			...
			<table class=editTable cellSpacing=1 cellPadding=0 width="100%"
				...
				<tr bgcolor="#ECF3FD">
					...
					<td width="10%"><input type="button" name="button"  onClick="history.back() "  value="返回"></td>
					<td width="43%"></td>
				</tr>
			</table>
