...
public class ComDeleteServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String  result=  "";
			try {
				result = webComponentDao.deleteOneComponent(comId);
			} catch (Exception e) {
		...
		if (result.equals("")) {
			request.setAttribute("result", "组件删除成功");
		}else{
			request.setAttribute("result", "组件删除失败，存在调用关系,"+result);
		}
