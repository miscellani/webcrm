...
public class OperatorQueryDetailServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public OperatorQueryDetailServlet() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("/jsp/sec/operator_detail.jsp").forward(request, response);
	}
