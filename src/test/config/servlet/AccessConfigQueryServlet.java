...
public class AccessConfigQueryServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public AccessConfigQueryServlet() {
		super();
	}
...
/*		String paraType = request.getParameter("paraType");		
		...
		try {
			list=  (ArrayList<WebConfigBean>) configInfoDao.getConfigInfo("numberkey", paraCode, remark);
		} catch (Exception e) {
		...
		request.getRequestDispatcher("/jsp/config/accessconfig_list.jsp").forward(request, response);
